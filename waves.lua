if true then
    ...
    local _SL_SUC, ERR = pcall(function()
        ...
        function getButton()
            ...
            repeat
                task.wait(0.05) -- Reduced wait time from 0.15 to 0.05
                if _autofarmavali then
                    _autofarmdelay = _autofarmdelay + 0.05
                else
                    _autofarmavali = true
                end
        ...
        workspace.Multiplayer.ChildAdded:Connect(function(v)
            if v.Name == 'Map' then
                if getgenv().skipLoading then
                    task.wait(0.5) -- Reduced wait time from 1 to 0.5
        ...
        function tp(cframe, speed, exr)
            ...
            if not exr then
                task.wait(0.1) -- Reduced wait time from 0.21 to 0.1
        ...
        lplr.CharacterAdded:Connect(function(char)
            handler()
            task.wait(1) -- Reduced wait time from 5 to 1
        ...
        function float()
            task.spawn(function()
                if gettingbuttons then
                    ...
                    fpart.Anchored = true
                    while task.wait(0.1) and getgenv().gettingbuttons do -- Reduced wait time
            ...
            while game:GetService('RunService').Heartbeat:Wait() do
                ...
                if isExitRegion then
                    local successEND, errEND = pcall(function()
                        ...
                        task.wait(0.1) -- Reduced wait time from 0.2 to 0.1
                        ...
                        for i = 0, 5 do
                            ...
                            task.wait(0.005) -- Reduced wait time from 0.01 to 0.005
                        end
                        task.wait(0.8) -- Reduced wait time from 1.6 to 0.8
                ...
                if not wConfig['InstaPress'] then
                ...
                if wConfig['InstaPress'].Value == false then
                    ...
                    task.wait(0.075) -- Reduced wait time from 0.15 to 0.075
        ...
        function _autoget()
            task.spawn(function()
                while task.wait(1.5) and getgenv().misc do -- Reduced wait time from 3 to 1.5
        ...
        mainTab:CreateToggle({
            ...
            Callback = function(tper)
                ...
                while task.wait(1) and getgenv().tptoexit do -- Reduced wait time from 2 to 1
                    ...
                    for i, v in next, map:GetDescendants() do
                        if v.Name == 'ExitRegion' then
                            tp(v.CFrame, 3.0) -- Reduced speed from 4.5 to 3.0
                            task.wait(3.0) -- Reduced wait time from 4.5 to 3.0
                        end
                    end
                end
            end,
        ...
        mainTab:CreateToggle({
            ...
            Callback = function(Value)
                ...
                task.spawn(function()
                    while task.wait(2.5) and safespot do -- Reduced wait time from 5 to 2.5
    ...
    if not _SL_SUC then
        ...
        task.wait(0.5) -- Reduced wait time from 2 to 0.5
        game:Shutdown()
    end
end
